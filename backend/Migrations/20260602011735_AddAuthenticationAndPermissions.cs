        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_field_permissions_modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_module_permissions_roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_field_permissions_ModuleId",
                table: "field_permissions",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_field_permissions_RoleId_ModuleId_FieldName",
                table: "field_permissions",
                columns: new[] { "RoleId", "ModuleId", "FieldName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_module_permissions_ModuleId",
                table: "module_permissions",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_module_permissions_RoleId_ModuleId",
                table: "module_permissions",
